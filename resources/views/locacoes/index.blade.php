    ...
    <main>
        ...
        <section class="mt-2 relative h-[45vh]">
            <div class="container mx-auto px-4 py-8">
                <h1 class="text-3xl font-bold text-white mb-8">Veiculos Disponiveis</h1>
                            ...
                            <div class="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-xl transition-shadow duration-300 cursor-pointer"
                                ...
                                <div class="p-4">
                                    ...
                                    <div class="flex items-center mb-2">
                                        <svg class="w-5 h-5 text-black-600 mr-2" fill="currentColor"
                                            viewBox="0 0 20 20">
                                            <path
                                        ...
                                        <span class="text-gray-600">{{ $bem->numero_passageiros }} lugares</span>
                                    </div>
        ...
        <div id="propertyModal"
            ...
            <div class="bg-white rounded-lg p-8 max-w-2xl w-full mx-4">
                ...
                <div class="flex gap-x-8 items-center text-gray-600 mb-4">
                    ...
                    <!-- Par 3: Transmissão -->
                    <div class="flex items-center gap-x-1">
                        <svg class="steering-wheel" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                    ...
                    <!-- Par 4: Combustível -->
                    <div class="flex items-center gap-x-1">
                        <svg class="gas-pump" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                            stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                            xmlns="http://www.w3.org/2000/svg">
                            <!-- Pump body -->
                ...
                <!--Botão de reservar que redireciona para a view reserva.blade.php -->
                <button onclick="reservarAgora()"
                    class="border-2 bg-orange-700 text-white px-6 py-2 rounded-lg bg-orange-500 hover:bg-orange-800 hover:border-orange-200 transition-colors duration-300">
                    Reservar Agora
                </button>
        ...
        <script>
            ...
            function reservarAgora() {
                if (selectedVehicleId) {
                    window.location.href = `/veiculo/${selectedVehicleId}`;
                } else {
