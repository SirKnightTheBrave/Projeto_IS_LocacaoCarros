...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p><strong>Veiculo:</strong> {{ $modelo }}</p>
            <p><strong>Data de Reserva:</strong> {{Carbon::parse($data_inicio)->format('d-m-Y')}}</p>
            <p><strong>Data de Devolução:</strong> {{Carbon::parse($data_fim)->format('d-m-Y')}}</p>
